...
9.  In the textfield provided, replace any existing code with the code provided in the Folder [speech-assets](../speech-assets) (make sure to copy the raw-version without any special characters of your preferred language), then click "Apply Changes" or "Save Model".  
