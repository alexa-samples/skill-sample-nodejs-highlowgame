...
7.  **Copy and paste the [provided code](https://github.com/alexa/skill-sample-nodejs-highlowgame/blob/master/lambda/src/index.js) into the Lambda function code box.**  We have provided the code for this skill on [GitHub](https://github.com/alexa/skill-sample-nodejs-highlowgame/blob/master/lambda/src/index.js).  Delete the contents of the code box, and paste the contents of the new code.
Click "Save".
