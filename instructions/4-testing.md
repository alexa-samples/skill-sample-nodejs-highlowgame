...
6.  **Other testing methods to consider:**
    ...
    *  [Unit Testing with Alexa](https://github.com/alexa/skill-sample-nodejs-highlowgame/blob/master/unit-testing.md) - a modern approach to unit testing your Alexa skills with [Postman](http://getpostman.com) and [Amazon API Gateway](http://aws.amazon.com/apigateway).

7.  **Verify that cards are working properly.**  Open the Alexa app on your phone, or at http://alexa.amazon.com.

    *  Guess a number: "Alexa, ask High Low Game is it seven."
...
<br/><br/>
<a href="https://github.com/alexa/skill-sample-nodejs-highlowgame/blob/master/instructions/5-customization.md"><img src="https://m.media-amazon.com/images/G/01/mobile-apps/dex/alexa/alexa-skills-kit/tutorials/general/buttons/button_next_customization._TTH_.png" /></a>
